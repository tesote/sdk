...
1. [versioning.md](versioning.md) — v1/v2/v3 coexistence; back-compat policy
...
- Internal admin tooling, MCP transport details beyond `/v3/mcp`, webhook delivery infra.
