...
public final class MutationDuringPaginationException extends ApiException {
    public MutationDuringPaginationException(String message, String errorCode, int httpStatus,
