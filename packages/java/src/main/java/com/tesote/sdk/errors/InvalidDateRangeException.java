...
public final class InvalidDateRangeException extends UnprocessableContentException {
    public InvalidDateRangeException(String message, String errorCode, int httpStatus,
