...
public final class HistorySyncForbiddenException extends ApiException {
    public HistorySyncForbiddenException(String message, String errorCode, int httpStatus,
