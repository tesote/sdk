...
/// <summary>403 WORKSPACE_SUSPENDED — workspace blocked at the platform level.</summary>
public sealed class WorkspaceSuspendedException : ApiException
{
    /// <summary>Construct with the full required-field set.</summary>
    public WorkspaceSuspendedException(
