...
final class Accounts
{
    ...
    {
        return $this->transport->request('GET', '/v3/accounts', $query);
    }
    ...
    {
        return $this->transport->request('GET', '/v3/accounts/' . rawurlencode($id));
    }
    ...
    public function sync(string $id, ?string $idempotencyKey = null): ?array
    {
        return $this->transport->request(
            'POST',
            '/v3/accounts/' . rawurlencode($id) . '/sync',
            null,
            [],
