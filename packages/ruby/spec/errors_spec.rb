  ...
  describe '.from_response' do
    {
      ...
      'SYNC_IN_PROGRESS' => [409, TesoteSdk::SyncInProgressError],
      'INVALID_ORDER_STATE' => [409, TesoteSdk::InvalidOrderStateError],
      'UNPROCESSABLE_CONTENT' => [422, TesoteSdk::UnprocessableContentError],
      'INVALID_DATE_RANGE' => [422, TesoteSdk::InvalidDateRangeError],
      'MISSING_DATE_RANGE' => [422, TesoteSdk::MissingDateRangeError],
      'INVALID_CURSOR' => [422, TesoteSdk::InvalidCursorError],
      'INVALID_COUNT' => [422, TesoteSdk::InvalidCountError],
      'INVALID_LIMIT' => [422, TesoteSdk::InvalidLimitError],
      'INVALID_QUERY' => [422, TesoteSdk::InvalidQueryError],
      'VALIDATION_ERROR' => [400, TesoteSdk::ValidationError],
      'BATCH_VALIDATION_ERROR' => [400, TesoteSdk::BatchValidationError],
      'BANK_SUBMISSION_ERROR' => [422, TesoteSdk::BankSubmissionError],
      'RATE_LIMIT_EXCEEDED' => [429, TesoteSdk::RateLimitExceededError],
      'SYNC_RATE_LIMIT_EXCEEDED' => [429, TesoteSdk::SyncRateLimitExceededError],
      'ACCOUNT_NOT_FOUND' => [404, TesoteSdk::AccountNotFoundError],
      'TRANSACTION_NOT_FOUND' => [404, TesoteSdk::TransactionNotFoundError],
      'SYNC_SESSION_NOT_FOUND' => [404, TesoteSdk::SyncSessionNotFoundError],
      'PAYMENT_METHOD_NOT_FOUND' => [404, TesoteSdk::PaymentMethodNotFoundError],
      'TRANSACTION_ORDER_NOT_FOUND' => [404, TesoteSdk::TransactionOrderNotFoundError],
      'BATCH_NOT_FOUND' => [404, TesoteSdk::BatchNotFoundError],
      'CATEGORY_NOT_FOUND' => [404, TesoteSdk::CategoryNotFoundError],
      'COUNTERPARTY_NOT_FOUND' => [404, TesoteSdk::CounterpartyNotFoundError],
      'LEGAL_ENTITY_NOT_FOUND' => [404, TesoteSdk::LegalEntityNotFoundError],
      'WEBHOOK_NOT_FOUND' => [404, TesoteSdk::WebhookNotFoundError],
      'BANK_CONNECTION_NOT_FOUND' => [404, TesoteSdk::BankConnectionNotFoundError],
      'BANK_UNDER_MAINTENANCE' => [503, TesoteSdk::BankUnderMaintenanceError],
      'INTERNAL_ERROR' => [500, TesoteSdk::InternalServerError]
