...
End-user docs: <https://www.tesote.com/docs/sdk/ruby> (canonical).
...
v1 and v2 are poll-based. See the [Implementation Checklist on tesote.com](https://www.tesote.com/docs/sdk/ruby).
